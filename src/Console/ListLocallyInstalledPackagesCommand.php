 ...
 * @author JeroenG
 **/
class ListLocallyInstalledPackagesCommand extends BaseCommand
{
    /**
     ...
     * @var string
     */
    protected $signature = 'modulizer:module:list
    ...
    /**
     * Get all of the packages installed with Modulizer.
     *
     * @return array
     */
